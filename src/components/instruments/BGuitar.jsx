...
export default function BGuitar({
  packedSampler: bguitarSampler,
  label,
  toggle,
  callbacks,
  offReady,
  ...
  useEffect(() => {
    setVolume(bguitarSampler.getVolume());
    setAlternatives(bguitarSampler.getAlternatives());
    setVersion(bguitarSampler.getVersion());
  }, [bguitarSampler]);

  const handleVolumeChanged = useCallback(
    (value) => {
      setVolume(value);
      bguitarSampler.setVolume(value);
    },
    [bguitarSampler],
  );
  ...
  const handleVersionChanged = useCallback(
    (value) => {
      ...
      setVersion(value);
      bguitarSampler.setVersion(value, onSamplerChanged);
    },
    [offReady, callbacks, bguitarSampler, onSamplerChanged],
  );
